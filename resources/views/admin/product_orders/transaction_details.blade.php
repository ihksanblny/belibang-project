            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                ...
                <div class="item-product flex flex-col justify-between gap-y-10 p-5 border-b border-gray-300">
                    ...
                    <div>
                        ...
                        <p class="text-gray-600">{{ $order->product->creator->name }}</p>
                    </div>
                    ...
                    <div class="flex flex-row gap-x-3">
                        @if($order->is_paid)
                        <a href="{{route('admin.product_orders.download', $order)}}" class="py-3 px-5 bg-indigo-500 text-white rounded-md shadow hover:bg-indigo-600 transition">
                            Download Product
                        </a>
                        @endif
                    </div>
